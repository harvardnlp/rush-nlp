...
% 
% \medskip \ind \href{ http://nlp.seas.harvard.edu/NamedTensor }{ Tensor Considered Harmful }
% \begin{itemize}
% \item  extend PyTorch tensor with named dimensions
% \end{itemize}
% 

% 
% \medskip \ind \href{ http://gltr.io/dist/index.html }{ Giant Language model Test Room }
% \begin{itemize}
% \item  detect whether a text could be real or fake
% \end{itemize}
% 

% 
% \medskip \ind \href{ https://github.com/justinchiu/sentclass }{ Tensor Variable Elimination for Plated Factor Graphs }
% \begin{itemize}
% \item  efficient tensor algebrain graphs with plates of variables
% \end{itemize}
% 
